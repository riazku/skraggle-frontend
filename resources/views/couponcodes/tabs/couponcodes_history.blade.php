...
<html lang="en">
  ...
  <body>
   <div class="container mx-auto p-6">
     ...
     <h1 class="text-[#551895] text-[22px] font-semibold" >Coupons</h1>
...
<button class="bg-[#EEEAFF] border-[#D6CEFA] border p-2 px-2 text-[#3F3F3F] rounded-lg ">No coupons have been added.</button>

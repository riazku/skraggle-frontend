...
<!-- <div class="flex flex-wrap space-x-1 mb-6">
  ...
  <div class="flex flex-col  items-start gap-2 mb-4">
    <h1 class="text-[#551895] text-[22px] font-semibold" >Email Templates xsjxksjxksjdk</h1>
   ...
   <div class="bg-white p-3 rounded-lg border border-gray-300 shadow">
            ...
            <div class="grid md:grid-cols-4 grid-cols-1 gap-3 gap-y-4">
              ...
              <div class="bg-[#EEEAFF] rounded-lg p-3 ">

                <div >
                  <h1 class="text-[#551895] text-[20px] font-medium">Default 023343</h1>
...
<button class="bg-[#551895] text-white rounded-lg py-2 px-6 mt-3">Action</button>

...
<body>
     ...
     <div class="container mx-auto p-6">
      ...
      <div class="flex gap-2 mt-5">
        ...
        <div class="bg-[#EEEAFF] rounded-md p-3 w-[40%]">
          <h4 class="text-[#551895] text-[16px]">Active Carts</h4>
          <h1 class="text-[#551895] !text-[42px] font-semibold">00.0</h1>
        </div>
         <div class="bg-[#EEEAFF] rounded-md p-3 w-[40%]">
          <h4 class="text-[#551895] text-[16px]">Assisted Carts</h4>
          <h1 class="text-[#551895] !text-[42px] font-semibold">00.0</h1>
        </div>
    
          <div class="bg-[#EEEAFF] rounded-md p-3 w-[40%]">
          <h4 class="text-[#551895] text-[16px]">Conversions (USD)</h4>
          <div class="flex justify-start items-center gap-4">
            <h1 class="text-[#551895] !text-[44px] font-semibold">00.0</h1>
            <h6
              class="bg-[#DAD2FB] rounded-md text-[#551895] px-3 p-[1px] mt-2"
            >
              00.0 (%)
            </h6>
          </div>
            ...
            <div class="bg-[#EEEAFF] rounded-md p-3 w-[40%]">
          <h4 class="text-[#551895] text-[16px]">Assisted Conversions (USD)</h4>
          <div class="flex justify-start items-center gap-4">
            <h1 class="text-[#551895] !text-[44px] font-semibold">00.0</h1>
            <h6
              class="bg-[#DAD2FB] rounded-md text-[#551895] px-3 p-[1px] mt-2"
